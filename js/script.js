var url = "https://api.nasa.gov/neo/rest/v1/feed?start_date=2015-09-07&end_date=2015-09-08&api_key=iRqU4DJLPdEtlYX48OVCLgcKteEwfPW6YhTjQj52";
...
$.ajax({
  ...
  success: function(results) {
    ...
    // documet.getElementById("count").innerHTML = results.element_count;
...
// Function creates a column containing the asteroids's name.
...
// This function is used to create the third colum, which contains close
